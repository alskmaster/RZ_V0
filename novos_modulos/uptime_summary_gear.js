  ...
  function ensureUptimeSummaryModal(){
    ...
    <div class="modal fade" id="customizeUpSumModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg"><div class="modal-content">
        <div class="modal-header"><h5 class="modal-title">Personalizar Módulo: Resumo de Disponibilidade</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body"><div class="row g-3">
          <div class="col-12">
            <div class="mb-3"><label class="form-label" for="upSumTitle">Título do Módulo</label>
              <input type="text" class="form-control" id="upSumTitle" placeholder="Ex: Uptime dos Servidores Críticos"/>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <div class="mb-3"><label class="form-label" for="upSumZabbixServiceTag">Filtrar por Tag de Serviço Zabbix</label>
              <input type="text" class="form-control" id="upSumZabbixServiceTag" placeholder="Ex: Business:ERP (opcional)">
              <div class="form-text">Usado para selecionar os Serviços Zabbix corretos para cálculo de SLA.</div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="mb-3"><label class="form-label" for="upSumThresholdCritical">Limiar Crítico (% Uptime)</label>
