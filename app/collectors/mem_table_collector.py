...
class MemTableCollector(BaseCollector):
    """
    Memória (Tabela): apresenta Min/Avg/Max por host com filtros e resumo.
    ...
    def collect(self, all_hosts, period):
        ...
        if df is None or df.empty:
            return self.render('mem_table', {'table_html': '<p><i>Sem dados de memória para o período selecionado.</i></p>', 'summary_text': None})
        ...
        if show_summary:
            ...
            summary = f"Tabela de uso de Memória por host (Min/Avg/Max), {ord_txt}. Período: {per_txt}. Itens exibidos: {items}."

        return self.render('mem_table', {'table_html': html, 'summary_text': summary})
